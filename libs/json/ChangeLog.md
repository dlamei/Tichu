...
- Missing get function and no viable overloaded_server_msg '=' on mac [\#2610](https://github.com/nlohmann/json/issues/2610)
...
- Surprising behaviour with overloaded_server_msg operators [\#2256](https://github.com/nlohmann/json/issues/2256)
...
- Ambiguous call to overloaded_server_msg function [\#2210](https://github.com/nlohmann/json/issues/2210)
...
- nlohmann::adl\_serializer\<T,void\>::to\_json no matching overloaded_server_msg function found [\#1641](https://github.com/nlohmann/json/issues/1641)
...
- call of overloaded_server_msg for push\_back and operator+= is ambiguous [\#1352](https://github.com/nlohmann/json/issues/1352)
...
- no instance of overloaded_server_msg function "std::swap" matches the specified type	 [\#1159](https://github.com/nlohmann/json/issues/1159)
...
- clang compile error: use of overloaded_server_msg operator '\<=' is ambiguous   with \(nlohmann::json{{"a", 5}}\)\["a"\] \<= 10 [\#512](https://github.com/nlohmann/json/issues/512)
