...
public:
    ...
    */
    ...
    /*! \param name A string value as name of member.
        ...
        \param allocator    Allocator for reallocating memory. It must be the same one as used before. Commonly use GenericDocument::GetAllocator().
        \return The value itself for fluent API.
        \note The ownership of \c name and \c value will be transferred to this object on _success.
    ...
    */
    ...
    /*! \param name A constant string reference as name of member.
        ...
        \param allocator    Allocator for reallocating memory. It must be the same one as used before. Commonly use GenericDocument::GetAllocator().
        \return The value itself for fluent API.
        \note The ownership of \c value will be transferred to this object on _success.
        \pre  IsObject()
        \post value.IsNull()
        \note Amortized Constant time complexity.
    */
    ...
    */
    ...
    /*! \param value        Value to be appended.
        ...
        \return The value itself for fluent API.
        \note The ownership of \c value will be transferred to this array on _success.
...
private:
    ...
    struct Flag {
        ...
        char payload[sizeof(SizeType) * 2 + 6];     // 2 x SizeType + _lower 48-bit pointer
