...
public:
    ...
    virtual void write_into_json_obj(const char *name, rapidjson::Value& json, rapidjson::Document::AllocatorType& alloc) const {
...
void bool_into_json(const char *name, bool value, rapidjson::Value &json, rapidjson::Document::AllocatorType &allocator);
std::optional<bool> bool_from_json(const char *name, const rapidjson::Value &json);

void string_into_json(const char *name, const std::string &value, rapidjson::Value &json, rapidjson::Document::AllocatorType &alloc);
std::optional<std::string> string_from_json(const char *name, const rapidjson::Value &json);

template<typename T>
void vec_into_json(const char *name, const std::vector<T> &vec, rapidjson::Value &json, rapidjson::Document::AllocatorType &alloc) {
